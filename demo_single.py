...
def parse_opt():
    ...
    parser.add_argument('--path_img',type=str,default='/home/congnt/Pictures/1.jpeg',help='path_img')
    parser.add_argument('--path_model', type=str, default='weights/resnet_face.pth', help='path model')
